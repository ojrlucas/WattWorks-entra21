...
public class CadastroUnidadeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            Unidade uni = new Unidade(request.getParameter("descricao"), request.getParameter("cnpjUnidade"), request.getParameter("subgrupoId"), 
            		request.getParameter("modalidadeId"), entidadeId);
